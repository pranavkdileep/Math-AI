...
def analyze_image(img: Image,dict_of_vars: dict):
    ...
    prompt = (
        ...
        f"Note: if image repersents any event that related to any number or expression then consider it example : image represent 911 then consider expression 9 divided by 11. "
        f"For example: "
        f"Q. 2 + 3 * 4 "
        f"(3 * 4) => 12, 2 + 12 = 14. "
        f"Q. 2 + 3 + 5 * 4 - 8 / 2 "
